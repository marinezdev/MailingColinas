...
namespace CRM.Repository
{
    public class ClassSubClassEtiquetasRepositorio
    {
        ...
        public ClassSubClassEtiquetas SeleccionarPorIdClasificacionIdSubClasificacion(string idC, string idSC)
        {
        ...
        public UsuariosRoles SeleccionarPorIdClasificacionIdSubClasificacionParaEdicion(string idC, string idSC)
        {
        ...
        public int Modificar(string etiqueta1, string etiqueta2, string etiqueta3, string etiqueta4, string idclasificacion, string idsubclasificacion)
        {
